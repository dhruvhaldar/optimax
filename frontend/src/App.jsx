...
const LoadingSpinner = () => (
  <div
    role="status"
    aria-live="polite"
    className="flex flex-col items-center justify-center py-20 h-full w-full"
  >
    <svg
      aria-hidden="true"
...
function App() {
  ...
  useEffect(() => {
    const activeLabel =
      TABS.find((tab) => tab.id === activeTab)?.label || "Optimax";
    ...
    <div className="container mx-auto px-4 py-8 relative">
      ...
      <header className="glass-panel p-8 mb-8 text-center bg-gradient-to-r from-white/5 to-white/10">
        ...
        <p className="text-slate-300 text-lg">
          Applied Linear Optimization - Solver & Visualizer
        </p>
      </header>

      <div
        role="tablist"
        aria-label="Solver selection"
      ...
      >
        <Suspense fallback={<LoadingSpinner />}>
          ...
          <div
            id="panel-colgen"
            role="tabpanel"
            aria-labelledby="tab-colgen"
            hidden={activeTab !== "colgen"}
          >
          ...
          <div
            id="panel-lagrangian"
            role="tabpanel"
            aria-labelledby="tab-lagrangian"
            hidden={activeTab !== "lagrangian"}
          >
          ...
          <div
            id="panel-stochastic"
            role="tabpanel"
            aria-labelledby="tab-stochastic"
            hidden={activeTab !== "stochastic"}
          >
