...
const IPSolver = () => {
  ...
  const solveIP = async () => {
    ...
    try {
      ...
      setError(
        "Invalid input format. Please ensure your vectors and matrices are formatted as valid JSON (e.g., [1, 2] or [[1, 2], [3, 4]]).",
      );
      setLoading(false);
      return;
    }
        ...
        >
          ...
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            ...
            <div className="bg-white/5 p-4 rounded-lg">
              ...
              <dd className="text-lg font-semibold text-white">
                {result.fun !== null && result.fun !== undefined
                  ? result.fun.toFixed(4)
                  : "N/A"}
              </dd>
            </div>
            <div className="col-span-1 md:col-span-2 bg-white/5 p-4 rounded-lg">
              ...
              <dd>
                <code
                  className="text-cyan-300 font-mono overflow-x-auto block focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
                  tabIndex={0}
                  role="region"
          ...
          {result.tree_plot && (
            <div>
              ...
              <img
                src={`data:image/png;base64,${result.tree_plot}`}
                alt="Branch and Bound Tree Visualization"
                tabIndex={0}
